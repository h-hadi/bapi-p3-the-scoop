...
// my source of soloving this project was relied on two sources
// folwing the logic of creating articles
// and this link https://github.com/spereverde/codecademy-the-scoop/blob/master/server.js
let database = {
  users: {},
  articles: {},
  nextArticleId: 1,
...
const routes = {
  ...
  //define comments like the articles
  '/comments': {
    'POST': createComment
  },
  '/comments/:id': {
